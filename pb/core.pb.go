...
type QuorumCert struct {
	...
	Quotas     []float64    `protobuf:"fixed64,3,rep,packed,name=quotas,proto3" json:"quotas,omitempty"`
...
func (x *QuorumCert) GetQuotas() []float64 {
	if x != nil {
		return x.Quotas
	}
	return nil
...
var file_core_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x61, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x01, 0x52, 0x06, 0x71, 0x75, 0x6f, 0x74,
